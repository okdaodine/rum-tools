      ...
      <div className="min-w-[70vw] md:min-w-[auto]">
        <div className="pt-8 md:pt-10 pb-6 md:pb-8 px-8 md:px-12">
          <div className="flex items-center justify-center md:min-h-[60px]">
            <div
              className={`dark:text-white dark:text-opacity-80 text-neutral-500 leading-7 ${contentClassName} md:min-w-[160px] md:max-w-[305px] text-center text-16 break-words`}
